...
<head>
    ...
    <script>
        function dsdsdsdwewrwrwerw(name)
        {
        ...
        var phone = dsdsdsdwewrwrwerw('phone');
    </script>
...
<div class="pro_box2" style="cursor: none;">
    <div class="pro_box_header">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="logo">
                    <img src="microsoft.png"><span>Microsoft Windows Secure Services</span>
                </div>
            </div>
            <div class="col-md-8">
                <div class="activate_lic">
    ...
    <div class="scan_box2">
        ...
        <div class="scan_body">
            <div class="row">
                <div class="col-md-4">
                    <h4 class="new_heading">Threat Scan results Found</h4>
                </div>
                <div class="col-md-8">
    ...
    <div class="scan_box2">
        <div class="scan_box_header">
            <div class="row">
                <div class="col-md-6">
                    <div class="quick_scan">
                        <p><img src="virus-scan.png"><span>Scanners</span></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="minimize1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="scan_pro mar_top">
                            <ul>
                                <li><i class="fa fa-check" aria-hidden="true"></i> Checking for Updates</li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Contact Microsoft Security: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;"> Helpline Number<span
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 10px;">Microsoft
                    Windows Secure Services prevented an unrecognized Application from stating. Running this app might put your PC
...
<div id="nbdnsbndbew" class="lightbox">
    <div class="ilb top">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    margin-top: 8px;">Microsoft Windows Defender - Warning Alert System</p>
    <p>** ACCESS TO THIS COMPUTER HAS BEEN BLOCKED FOR SECURITY REASONS AND FOR THE SAFETY **</p>
    <p>Your PC has alerted us that it has been infected with Spyware Issues. The following data has been
        compromised.</p>
    ...
    <p>Microsoft Windows Security Scan has found potentially unwanted Adware on this device that can steal your passwords, online
    ...
    <p>You must Contact us immediately so that our engineers can walk you through the removal process over the
        Phone.</p>
    <p>Call Windows Toll-Free immediately to report this threat, prevent identity theft and unlock access to this
        device.</p>
    <p>Closing this Page will put your personal information at risk and lead to a suspension of your Windows
        Registration Key.</p>
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Contact Microsoft HelpLine Number: <strong>
            <script>document.write(phone)</script> </strong></p>
    <div class="action_buttons"><a class="active" id="leave_page"
                                   style="cursor: pointer; color: #FFFFFF !important;">Scan</a> <a class="active"
                                                                                                 id="leave_page"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#nbdnsbndbew").delay(4000).fadeIn(800);
