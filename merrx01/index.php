...
<html lang="en">
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-217279329-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-217279329-31');
</script>
...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
    ...
    <script>
        function dnsbdnwjhjkwhejkh(name)
        {
        ...
        var phone = dnsbdnwjhjkwhejkh('phone');
    </script>
...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Apple</span> <p style="font-weight: 600;">Contact Apple Support Helpline:</p>
            <h4 style="font-weight: 600;"><script>document.write(phone)</script> <br>(Toll Free)</h4>
...
<div class="messaging">
            ...
            <div class="incoming_msg">
              <div class="received_msg">
                <div class="received_withd_msg">
                  <p>Hi! I'm Cortana, a new AI powered chatbot. Please refer to the Apple Privacy Statement for more information.</p>
                  </div>
              </div>
            </div>
    ...
    box-shadow: 0 1.7px 1.7px 0 rgb(0 0 0 / 25%);"> This is a critical error. Please visit <a href="#" style="text-decoration: underline;color:#fff;">https://help.Apple.com</a> or <a href="#" style="text-decoration: underline;color:#fff;">contact Technical Support immediately.</a></p>
                  </div>
              </div>
            </div>
...
<div class="pro_box" style="cursor: none;">
    <div class="pro_box_header">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="logo">
                    <img src="microsoft.png"><span>Apple Security</span>
                </div>
            </div>
            <div class="col-md-8">
...
<div class="pro_box3" style="cursor: none;">
    <div class="pro_box_header">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="logo">
                    <img src="microsoft.png"><span>MacOSX Security</span>
                </div>
            </div>
            <div class="col-md-8">
                <div class="activate_lic">
...
<div id="nbdnsbndbew">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> MacOSX  Security Center</span>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Apple Support Helpline: <script>document.write(phone)</script> (Toll Free)</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
   <img src="new-scan-white.jpg" class="img-fluid">
    ...
    position: absolute;
    bottom: 46px;
    left: 42px;">Call Apple Support: <strong>
...
<!--start sticky footer-->
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Contact Apple Support: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;"><script>document.write(phone)</script> </span> (Toll-Free)</span>
    <p>&nbsp;</p>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        var dnsbdsanmdmnasbdjgwqjkek = 0;
        var interval = setInterval(function () {
            dnsbdsanmdmnasbdjgwqjkek += 10;
            $("#dynamic")
                .css("width", dnsbdsanmdmnasbdjgwqjkek + "%")
                .attr("aria-valuenow", dnsbdsanmdmnasbdjgwqjkek)
                .text(dnsbdsanmdmnasbdjgwqjkek + "% Complete");
            if (dnsbdsanmdmnasbdjgwqjkek >= 100)
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#nbdnsbndbew").delay(3000).fadeIn(800);
